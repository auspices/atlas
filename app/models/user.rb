...
class User < ApplicationRecord
  ...
  has_many :collections, -> { order updated_at: :desc }, dependent: :destroy, inverse_of: :user
  has_many :images, -> { order created_at: :desc }, dependent: :destroy, inverse_of: :user
  has_many :texts, -> { order created_at: :desc }, dependent: :destroy, inverse_of: :user
  has_many :links, -> { order created_at: :desc }, dependent: :destroy, inverse_of: :user
  has_many :attachments, -> { order created_at: :desc }, dependent: :destroy, inverse_of: :user
